...
export class DynamicView {
    ...
    */
    'paperSize'?: DynamicViewPaperSizeEnum;
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "externalBoundariesVisible",
            "baseName": "externalBoundariesVisible",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return DynamicView.attributeTypeMap;
    }
...
export enum DynamicViewPaperSizeEnum {
